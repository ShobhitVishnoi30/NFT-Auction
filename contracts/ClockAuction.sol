...
import "./Interfaces/IWhaleNFT.sol";
...
contract ClockAuction is Ownable {
  ...
  // WhaleNFT contract interface
  IWhaleNFT private sNft_;
   ...
   * @param _sNft WhaleNFT contract address
   */
  constructor(address _sNft) {
    require(_sNft != address(0), "Invalid address");

    sNft_ = IWhaleNFT(_sNft);
